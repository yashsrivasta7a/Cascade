...
import { Button, DotPattern, PageBackground } from "@/components/ui";
        ...
        <div className="max-w-4xl mx-auto px-6 py-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-semibold text-white tracking-tight">Workflows</h1>
            ...
            <Link href="/workflows/new">
              <Button leftIcon={<Plus className="w-4 h-4" />}>New</Button>
            </Link>
          </div>
      ...
      <div className="flex-1 overflow-auto">
        <div className="max-w-4xl mx-auto px-6 py-6">
          ...
          {!isLoading && workflows.length === 0 && (
            <div className="relative flex flex-col items-center justify-center py-20 rounded-2xl border border-zinc-800/60 bg-zinc-900/30 overflow-hidden">
