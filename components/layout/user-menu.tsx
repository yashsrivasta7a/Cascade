  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        className="p-2 rounded-lg text-gray-500 dark:text-zinc-400 hover:text-gray-700 dark:hover:text-zinc-200 hover:bg-gray-100 dark:hover:bg-zinc-800/50 transition-colors"
          ...
          {showDropdown && (
            <>
              ...
              <motion.div
                ...
                className="absolute right-0 top-full mt-2 w-64 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl shadow-2xl overflow-hidden z-50"
              >
                ...
                <div className="py-1">
                  <Link href="/settings?tab=profile">
                    <button
                      onClick={() => setShowDropdown(false)}
                      className="w-full px-4 py-2.5 flex items-center gap-3 text-sm text-gray-600 dark:text-zinc-400 hover:bg-gray-50 dark:hover:bg-zinc-800/50 hover:text-gray-900 dark:hover:text-zinc-200 transition-colors"
                    >
                ...
                <div className="px-4 py-2 border-t border-gray-100 dark:border-zinc-800">
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-gray-500 dark:text-zinc-500">Theme</span>
