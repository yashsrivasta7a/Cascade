...
export function ExecutionPanel({
    ...
    return (
      <motion.div
        ...
        className={cn(
          ...
          "bg-zinc-950/90 backdrop-blur-xl border border-white/10 rounded-2xl",
      ...
      >
        <button
          ...
          className="flex items-center gap-4 px-4 py-3 hover:bg-white/5 transition-colors rounded-2xl"
        >
          <div className="relative">
            ...
            <span className="absolute -top-1 -right-1 w-4 h-4 rounded-full bg-white/20 text-[10px] font-bold text-white flex items-center justify-center border border-white/10">
              {completedNodes}
            </span>
          </div>
          ...
          <Maximize2 className="w-4 h-4 text-zinc-500 ml-2" />
        </button>
      </motion.div>
    );
  }
  ...
  return (
    <motion.div
      ...
      className={cn(
        "w-96 h-full bg-zinc-950/95 backdrop-blur-xl border-l border-white/5",
    ...
    >
      ...
      <div className="p-4 border-b border-white/5">
        ...
        <div className="flex items-center justify-between text-xs">
          ...
          <div className="flex items-center gap-1 text-zinc-300 bg-white/5 px-2 py-1 rounded border border-white/10">
              ...
              >
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    {config.pulse && (
                      <span className="absolute inset-0 rounded-lg bg-white/10 animate-ping" />
                    )}
                  </div>
                  ...
                  <div className="flex-1 text-left min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-0.5">
                      ...
                      {node.providerAttempt && node.totalProviders && node.totalProviders > 1 && (
                        <span className="text-[10px] text-zinc-300 bg-white/5 px-1 rounded border border-white/10">
