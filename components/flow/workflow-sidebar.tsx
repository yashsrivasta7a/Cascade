    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            {/* Glass container */}
            <div className="relative h-full flex flex-col bg-white/90 dark:bg-white/[0.03] backdrop-blur-2xl backdrop-saturate-150 border-r border-gray-200/80 dark:border-white/[0.08] shadow-2xl shadow-gray-400/30 dark:shadow-black/50">
              ...
              <div className="relative p-4 border-b border-gray-200/50 dark:border-white/[0.06]">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button
                    onClick={onClose}
                    className="p-2 rounded-xl text-gray-400 dark:text-zinc-500 hover:text-gray-700 dark:hover:text-white hover:bg-gray-100/80 dark:hover:bg-white/[0.05] transition-all"
                  >
                    <X className="w-4 h-4" />
                  </button>
                </div>
                ...
                <div className="space-y-1">
                  <Link
                    href="/dashboard"
                    onClick={onClose}
                    className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-gray-600 dark:text-zinc-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100/60 dark:hover:bg-white/[0.05] transition-all group"
                  >
                    <div className="p-1.5 rounded-lg bg-gray-100/80 dark:bg-white/[0.05] group-hover:bg-gray-200/80 dark:group-hover:bg-white/[0.08] transition-colors">
              ...
              <div className="relative px-4 py-3">
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2.5 bg-gray-100/60 dark:bg-white/[0.03] border border-gray-200/60 dark:border-white/[0.06] rounded-xl text-sm text-gray-700 dark:text-zinc-200 placeholder:text-gray-400 dark:placeholder:text-zinc-600 focus:outline-none focus:border-gray-300/80 dark:focus:border-white/[0.12] focus:bg-white/80 dark:focus:bg-white/[0.05] transition-all backdrop-blur-sm"
                  />
              ...
              <div className="relative flex-1 overflow-y-auto px-2 pb-4 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-white/10 scrollbar-track-transparent">
                {isLoading ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-12 text-center">
                    <div className="w-10 h-10 rounded-xl bg-gray-100/80 dark:bg-white/[0.03] border border-gray-200/60 dark:border-white/[0.06] flex items-center justify-center mb-3 backdrop-blur-sm">
                          ...
                          {isEditing ? (
                            <div className="flex items-center gap-2 px-3 py-2">
                              <input
                                ...
                                className="flex-1 px-2 py-1.5 text-sm bg-white/80 dark:bg-black/30 border border-gray-200/80 dark:border-white/[0.1] rounded-lg text-gray-700 dark:text-zinc-100 focus:outline-none focus:border-blue-500/50 backdrop-blur-sm"
                              />
                              <button
                            ...
                            <div className="px-3 py-3 bg-red-50/80 dark:bg-red-500/[0.05] rounded-xl border border-red-200/80 dark:border-red-500/10 backdrop-blur-sm">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <button
                                  ...
                                  className="flex-1 px-2 py-1.5 text-xs font-medium bg-gray-100/80 dark:bg-zinc-800/80 text-gray-600 dark:text-zinc-400 rounded-lg hover:bg-gray-200/80 dark:hover:bg-zinc-700/80 transition-colors"
                                >
                                  Cancel
                                </button>
                              </div>
                            ...
                            <div className="flex items-center">
                              ...
                              >
                                <div className={cn(
                                  ...
                                  isActive ? "bg-blue-100/80 dark:bg-blue-500/15 text-blue-600 dark:text-blue-400" : "bg-gray-100/80 dark:bg-white/[0.03] text-gray-500 dark:text-zinc-600 group-hover:text-gray-700 dark:group-hover:text-zinc-400"
                                )}>
                                ...
                                <button
                                  ...
                                  className={cn(
                                    ...
                                    menuOpen === workflow.id
                                      ? "bg-gray-100/80 dark:bg-white/[0.08] text-gray-700 dark:text-zinc-300"
                                      : "text-gray-400 dark:text-zinc-600 opacity-0 group-hover:opacity-100 hover:bg-gray-100/80 dark:hover:bg-white/[0.06] hover:text-gray-700 dark:hover:text-zinc-300"
                                  )}
                                >
                                ...
                                <AnimatePresence>
                                  {menuOpen === workflow.id && (
                                    <motion.div
                                      ...
                                      className="absolute right-0 top-full mt-1 w-36 bg-white/90 dark:bg-white/[0.05] backdrop-blur-xl border border-gray-200/80 dark:border-white/[0.1] rounded-xl overflow-hidden z-20 shadow-xl shadow-gray-300/30 dark:shadow-black/40"
                                    >
                                      <button
                                        onClick={() => handleStartRename(workflow.id, workflow.name)}
                                        className="w-full flex items-center gap-2 px-3 py-2.5 text-xs font-medium text-gray-700 dark:text-zinc-300 hover:bg-gray-100/80 dark:hover:bg-white/[0.05] transition-colors"
                                      >
              ...
              {/* User Footer */}
              <div ref={userMenuRef} className="relative p-4 border-t border-gray-200/50 dark:border-white/[0.06]">
                {/* User Menu Dropdown */}
                <AnimatePresence>
                  {userMenuOpen && (
                    <motion.div
                      ...
                      className="absolute bottom-full left-4 right-4 mb-2 bg-white/95 dark:bg-zinc-900/95 backdrop-blur-xl rounded-xl border border-gray-200 dark:border-white/[0.1] shadow-xl shadow-black/10 dark:shadow-black/30 overflow-hidden"
                    >
                      <div className="p-1">
                        <Link
                          href="/settings/profile"
                          onClick={() => { setUserMenuOpen(false); onClose(); }}
                          className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-700 dark:text-zinc-300 hover:bg-gray-100 dark:hover:bg-white/[0.06] transition-colors"
                        >
                          <UserCircle className="w-4 h-4 text-gray-500 dark:text-zinc-400" />
                ...
                >
                  {user?.imageUrl ? (
                    ...
                    <img 
                      ...
                      className="w-9 h-9 rounded-xl object-cover border border-gray-200/80 dark:border-white/[0.1]"
                    />
                  ) : (
                  ...
                  <ChevronUp className={cn(
                    "w-4 h-4 text-gray-400 dark:text-zinc-500 transition-transform",
