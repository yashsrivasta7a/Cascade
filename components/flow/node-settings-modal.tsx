...
export function NodeSettingsModal({
 ...
 <p className="text-[10px] text-slate-700 font-medium">Configure node settings</p>
 </div>
 </div>
 <button
 onClick={onClose}
...
export function SelectInput({
 ...
 className="fs-select w-full px-3 py-2.5 rounded-xl text-sm cursor-pointer transition-colors"
 >
 {options.map((opt) => (
...
export function ToggleInput({
 ...
 {description && (
 <p className="text-[10px] text-slate-700 mt-0.5">{description}</p>
 )}
 </div>
 <button
