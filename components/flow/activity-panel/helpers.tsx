...
export const statusStyles = {
 PENDING: { icon: <Clock className="w-3.5 h-3.5" />, color: "text-slate-700 dark:text-zinc-400", bg: "bg-white dark:bg-zinc-500/15", border: "border-gray-300 dark:border-zinc-500/30", label: "Pending", cardBg: "bg-white dark:bg-white/[0.03]", accentBar: "bg-gray-400 dark:bg-zinc-500" },
 QUEUED: { icon: <Clock className="w-3.5 h-3.5" />, color: "text-slate-700 dark:text-zinc-400", bg: "bg-white dark:bg-zinc-500/15", border: "border-gray-300 dark:border-zinc-500/30", label: "Queued", cardBg: "bg-white dark:bg-white/[0.03]", accentBar: "bg-gray-400 dark:bg-zinc-500" },
