...
function KeyboardShortcutsModalComponent({ isOpen, onClose }: KeyboardShortcutsModalProps) {
 ...
 <button
 onClick={onClose}
 className="p-2 rounded-xl text-slate-800 hover:text-slate-700 dark:text-zinc-500 dark:hover:text-slate-700 hover:bg-gray-100/80 dark:hover:bg-white/[0.05] transition-all duration-200"
 >
 <X className="w-5 h-5" />
 </button>
 </div>
 ...
 <h3 className="text-xs font-semibold text-slate-700 dark:text-zinc-500 uppercase tracking-wider">
 {group.title}
 </h3>
