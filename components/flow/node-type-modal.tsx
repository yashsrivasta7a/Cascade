...
export function NodeTypeModal({
 ...
 <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-700 group-focus-within:text-slate-600 transition-colors" />
 <input
 type="text"
 ...
 <p className="text-sm font-medium text-slate-600">No nodes found</p>
 <p className="text-xs text-slate-700 mt-1">Try searching for something else</p>
 </div>
 ) : (
 ...
 <div className="text-[11px] text-slate-700 truncate group-hover:text-slate-700 transition-colors">
 {node.action}
 </div>
 </div>
 </button>
