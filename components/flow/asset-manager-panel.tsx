...
function getNodeIcon(nodeType: string) {
 ...
 default: return <Zap className="w-3.5 h-3.5 text-slate-700 dark:text-zinc-400" />;
 }
}
...
function getNodeColor(nodeType: string): string {
 ...
 default: return "bg-gradient-to-r from-gray-50 to-slate-50 dark:from-zinc-500/15 dark:to-zinc-600/10 border-l-4 border-l-gray-400 border-y border-r border-blue-100 dark:border-zinc-500/30";
 }
}
...
export function AssetManagerPanel({ 
 ...
 style={{ right: "16px" }}
 className="fixed top-16 z-50 w-[340px] bg-white dark:bg-black/60 rounded-2xl border border-blue-100 dark:border-white/[0.08] overflow-hidden shadow-xl shadow-gray-200/80 dark:shadow-black/40 flex flex-col max-h-[calc(100vh-120px)]"
 >
 {/* Dot Pattern */}
 ...
 <Inbox className="w-5 h-5 text-slate-800 dark:text-zinc-600" />
 </div>
 ...
 {/* Preview */}
 <div className="w-14 h-14 rounded-lg bg-white dark:bg-black/30 flex items-center justify-center shrink-0 overflow-hidden border border-blue-100 dark:border-white/[0.06]">
 {asset.type === "image" ? (
 ...
 className="p-1.5 rounded-lg text-slate-800 dark:text-zinc-500 hover:text-slate-900 dark:hover:text-white hover:bg-white/70 dark:hover:bg-white/5 transition-colors"
 title="Focus node"
 >
