...
export function Badge({
 ...
 const variants = {
 default: "bg-white text-slate-800 border-blue-100 dark:bg-white/5 dark:text-white/60 dark:border-white/10",
 ...
 secondary: "bg-white text-slate-700 border-blue-100 dark:bg-white/5 dark:text-white/70 dark:border-white/10",
 };
